...
admin_email = 'swathineelam295@gmail.com'
admin_password = 'glpf ouda oume vrnm'
...
def shopping_cart(userid):
    ...
    return render_template('shopping_cart.html', data = cart_details, user_id = userid, total = total, message = msg )
